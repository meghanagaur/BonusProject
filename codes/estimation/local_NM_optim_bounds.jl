...
objFunc(x) = objFunction_WB(x, endogParams, pb, zshocks, data_mom, W)[1]
...
minimizer     = [ transform_params(minimizer_t[i], pb[i], endogParams2[i]) for i = 1:length(endogParams2) ] 
