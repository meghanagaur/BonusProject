...
# Plot u_ss
p4 = heatmap(par1_grid, par2_grid, u_ss, title=L"u_{ss}")
xlabel!(par1_str)
ylabel!(par2_str)
...
# Plot u_ss_1
p1 = heatmap(par1_grid, par2_grid, u_ss, title=L"u_{ss}^1")
xlabel!(par1_str)
ylabel!(par2_str)

# Plot u_ss_2
p2 = heatmap(par1_grid, par2_grid, u_ss_2, title =L"u_{ss}^2") 
xlabel!(par1_str)
ylabel!(par2_str)
...
# Plot dlw_dly_1
p4 = heatmap(par1_grid, par2_grid, dlw_dly, title=L"\frac{\partial \log w_{it}^2 }{ \partial \log y_{it} }")
xlabel!(par1_str)
ylabel!(par2_str)
