...
file_save      = "jld/test_"*file_str*".txt"         # file to-save 
N_procs        = 2                                   # number of jobs in job array
...
N_string       = 2                                 # length of each worker string
...
@time output = tiktak(init_points, file_save, init_x, param_bounds, param_vals, param_est, shocks, data_mom, W, I_max, test=false, max_iter = 5)
