...
@everywhere begin
    ...
    include("../functions-est-z/smm_settings.jl") # SMM inputs, settings, packages, etc.
...
# Save the output
save("smm-est-z/jld/"*file*".jld2",  Dict("moms" => moms, "fvals" => fvals, "mom_key" => mom_key, "param_est" => param_est, "param_vals" => param_vals, 
