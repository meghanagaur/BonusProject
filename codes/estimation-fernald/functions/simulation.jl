...
"""
function rand_shocks(; N_sim_micro = 10^5, T_sim_micro = 13, N_sim_macro = 10^4, N_sim_macro_workers = 10^3, 
    T_sim_macro = 828, burnin = 5000, N_sim_macro_est_alp = 10^3, set_seed = true, seed = 512)
