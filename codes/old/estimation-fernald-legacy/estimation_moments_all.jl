...
## Logistics
files  = ["fix_hbar10" "fix_chi0_cyc0" "fix_a_bwf06" "fix_a_bwf10"] # "fix_hbar10_cyc025" "fix_hbar10_cyc05" "fix_hbar10_cyc075" "fix_hbar10_cyc125" "fix_hbar10_cyc15"]
λ      = 1600 
...
for i = 1:length(files)
    ...
    if fix_a == false
        ...
        @time output = simulate(modd, shocks; check_mult = false, est_alp = false, λ = λ)      
