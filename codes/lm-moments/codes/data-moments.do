...
foreach var of local prod {
	eststo hp100000_`var': reg ltightness_hp l`var'_hp
	eststo hp1600_`var':   reg ltightness_hp1600 l`var'_hp1600
}
...
foreach var of local prod {
	...
	*tsfilter hp l`var'_hp1600 = l`var', smooth(1600)
	...
	eststo hp100000_`var'_sh: reg ltightness_hp_sh l`var'_hp
	eststo hp1600_`var'_sh:   reg ltightness_hp1600_sh l`var'_hp1600
}

* use the original ALP data from Shimer 
eststo hp1600_alpsh_sh:   reg ltightness_hp1600_sh lalp_hp1600_sh
eststo hp100000_alpsh_sh: reg ltightness_hp_sh lalp_hp_sh
